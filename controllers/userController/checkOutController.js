  ...
  try {
    ...
    if (req.session.user_id) {
      ...
      res.render("checkOutPage", {
        ...
        coupons: couponData,
        discount: offer,
        message: "Please check the details are proper",
      });
    }
...
const loadEditAddress = async (req, res) => {
  try {
    ...
    if (userData) {
      res.render("editAddressCheckoutpage", {
        user: req.session.user,
        product: userData,
      });
    } else {
      res.redirect("editAddressCheckoutpage");
    }
...
const saveloadAddress = async(req,res)=>{
  try {
    ...
    if (req.session.user_id) {
      ...
      console.log("successs aaaaadded");
    } else {
      res.redirect("/");
    }
